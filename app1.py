...
nltk.download('averaged_perceptron_tagger')  # Optional, but can help with tokenization
nltk.download('wordnet')  # Optional, useful for text processing
...
def healthcare_chatbot(user_input):
    ...
    if "sneeze" in user_input or "sneezing" in user_input:
        ...
        context = """
    Common healthcare-related scenarios including symptoms of colds, flu, and allergies,
